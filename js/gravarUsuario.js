...
// escutador para o evento Submit - Ele ficará escutando qdo o evento for disparado
// qdo for disparado, executar uma função
document.querySelector('#form-notas').addEventListener('submit', function(e)  {
    ...
    // verificando se usuário escolheu a disciplina
    ...
    document.querySelector('#data').textContent = new
